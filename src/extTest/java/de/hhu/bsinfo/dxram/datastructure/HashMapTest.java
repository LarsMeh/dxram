...
//    }
    ...
    public void extremePutAndGet(final DXRAM p_instance) {
        ...
        HashMap<Integer, Integer> map = service.createHashMap(m_id, entries, m_nodes, 4, 4, HashFunctions.MURMUR3_32, true);
        ...
        //map.logHashtable();
        //map.writeLocalBuckets(new File("/home/mehnert/log" + entries + ".txt"));
